    ...
    if results.multi_hand_landmarks:
        for handLms in results.multi_hand_landmarks:
            ...
            if lmList:    
                ...
                cv2.circle(img , (x1 ,y1) ,15 , (255,0,205) ,cv2.FILLED)
                cv2.circle(img , (x2 ,y2) ,15 , (255,0,205) ,cv2.FILLED)
            ...
            cv2.rectangle(img ,(50,150) , (85,400) ,(126,59,234) , 3)
            cv2.rectangle(img ,(50,int(volBar)) , (85,400) ,(126,59,234) , cv2.FILLED)
